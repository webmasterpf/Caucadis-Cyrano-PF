...
$emptyText = $view->display_handler->set_option('empty','<div class="vdl_intervenant"><p>Pas de contenu à afficher en ce moment.</p></div>');
...
elseif (empty($view->result)) {
    //Formatage du texte vide,ajout du titre de la vue
     $outputEmpty = '<div  id="bloc_vdl" class="vdl_intervenant"><h3 class="titre-h3">'.$view->get_title().'</h3>'.$emptyText.'</div>';
