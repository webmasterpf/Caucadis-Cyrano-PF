...
$viewname_vdlg1 = 'vdl_global';
$view = views_get_view ($viewname_vdlg1);
$view->set_display('block_1');
$emptyText = $view->display_handler->set_option('empty','<div class="vdl_projet"><p>Pas de contenu à afficher en ce moment.</p></div>');
...
elseif (empty($view->result)) {
    //Formatage du texte vide,ajout du titre de la vue
     $outputEmpty = '<div  id="bloc_vdl" class="vdl_projet"><h3 class="titre-h3">'.$view->get_title().'</h3>'.$emptyText.'</div>';
