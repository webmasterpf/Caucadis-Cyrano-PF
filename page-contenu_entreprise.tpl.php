...
?>
 <!-- ______________________ LAYOUT PAGE ENTREPRISE - LISTE CAUCADIS PAGE.TPL_______________________ -->
  ...
  <!-- ______________________ CONTENT TOP NODE_______________________ -->
        ...
        <div id="content-inner-entreprise-contenu" class="inner column center">
		  ...
		  <!-- ______________________ CONTENU CENTRAL _______________________ -->
                  <div id="middle-content" class="middle-entreprise-contenu">
