...
function cyrano_ca_webform_view_messages($node, $teaser, $page, $submission_count,$user_limit_exceeded,$total_limit_exceeded, $allowed_roles,$closed,$cached) {
...
function cyrano_ca_filefield_file($file) {
...
function cyrano_ca_more_link ($url, $title) {
